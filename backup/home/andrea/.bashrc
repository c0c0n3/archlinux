...
## NB the above is what you get by default---see /etc/skel
...
# NOTE: As of version 4.1, Pacman has a color option. 
# To activate: uncomment #Color line in /etc/pacman.conf.
